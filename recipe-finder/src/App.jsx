...
export default function App() {
  ...
  <div className="py-20 px-2 max-w-4xl mx-auto">
     ...
     <form className="my-16" onSubmit={handleSubmit}>
      ...
      border-2 border-neutral-200 focus:border-neutral-800 focus:ring-4 focus:ring-neutral-800
       outline-none lg:text-xl" 
       value={meal}
     ...
     <div className="grid gap-12">
      ...
      <img 
      src={meal.strMealThumb} alt={meal.strMeal} className="w-full"
      ...
      <p>{meal.strInstructions}</p>
        ...
        <ul className="flex items-center justifty-start gap-4 flex-wrap mt-8">
          {meal.strYoutube && (
            <li>
            <a href={meal.strYoutube} target="_blank" rel="noreferrer" className=" bg-neutral-200 font-normal text-base py-2 px-4 rounded-full 
          hover:bg-red-200 transition-all duration-150 hover: text-neutral-800">Video</a>
            </li>
          )}

             {meal.strSource && (
              <li>
            <a href={meal.strSource} target="_blank" rel="noreferrer" className=" bg-neutral-200 font-normal text-base py-2 px-6 rounded-full 
          hover:bg-red-200 transition-all duration-150 hover: text-neutral-800">Source
     ...
     </div> : <h2 className="text-3xl text-center
     text-neutral-800  
     font-bold mt-12">Sorry, we couldn't search for {meal} </h2>}
     </div>
  );
}